...
export type ReactReposQueryVariables = Exact<{
  query: Scalars['String'];
  type: SearchType;
  first?: Maybe<Scalars['Int']>;
}>;
...
export type ReactReposQuery = (
  ...
  & { search: (
    ...
    & { pageInfo: (
      { __typename?: 'PageInfo' }
      & Pick<PageInfo, 'startCursor' | 'hasNextPage' | 'endCursor' | 'hasPreviousPage'>
      ...
      { __typename?: 'Repository' }
      & Pick<Repository, 'name' | 'forkCount' | 'stargazerCount' | 'url'>
    ) | { __typename?: 'User' }>>> }
  ) }
);


export const ReactReposDocument = `
  ...
  search(query: $query, type: $type, first: $first) {
    ...
    `;
export const useReactReposQuery = <
      TData = ReactReposQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit }, 
      variables: ReactReposQueryVariables, 
      options?: UseQueryOptions<ReactReposQuery, TError, TData>
    ) => 
    useQuery<ReactReposQuery, TError, TData>(
      ['ReactRepos', variables],
      fetcher<ReactReposQuery, ReactReposQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, ReactReposDocument, variables),
      options
    );