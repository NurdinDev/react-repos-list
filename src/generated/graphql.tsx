...
export type GitHubSearchQueryVariables = Exact<{
  type: SearchType;
  query: Scalars['String'];
}>;
...
export function useGitHubSearchQuery(options: Omit<Urql.UseQueryArgs<GitHubSearchQueryVariables>, 'query'> = {}) {
  return Urql.useQuery<GitHubSearchQuery>({ query: GitHubSearchDocument, ...options });
};
